...
namespace AppGestionEMS.Controllers
{
    ...
    public class GrupoClasesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Cod_Grupo")] GrupoClases grupoClases)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Cod_Grupo")] GrupoClases grupoClases)
        {
            if (ModelState.IsValid)
            {
